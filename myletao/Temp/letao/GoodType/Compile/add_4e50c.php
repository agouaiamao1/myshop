...
<script type='text/javascript'>
		...
		URL = 'http://localhost/MyShop/index.php/GoodType/Index/add';
		...
		METH = 'http://localhost/MyShop/index.php/GoodType/Index/add';
...
<body>
    ...
    <form method='post' class='hd-form' action="<?php echo U('add');?>">
